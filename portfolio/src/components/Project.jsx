...
export const Project = () => {
  return (
    ...
    verify={"https://drive.google.com/drive/u/6/folders/19FdN02fzce7kkhTonSJbNUxMJHjv4YhU"}
  />
    <ProjectItem
    image={DataA}
    name="Data Analysis Project"
    organisation="Spatial & Geo-spatial data analysis."
    verify={"https://drive.google.com/drive/u/6/folders/1fEbuqmd3cEx4GdGeQqnH0PHf3Rr-OK70"}
  />
<ProjectItem
image={Mlp}
name="Machine Learning Project"
organisation="Face detection, age & gender prediction and emotion detection."
verify={"https://drive.google.com/drive/u/6/folders/1R39V5RRV-4jjh6C7az-4uqIl-2Vnuss8"}
/>
        </div>
      </div>
    </div>
